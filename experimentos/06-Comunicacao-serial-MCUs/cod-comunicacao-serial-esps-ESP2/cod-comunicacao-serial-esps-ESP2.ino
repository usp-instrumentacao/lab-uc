...
#define RX_BET_ESPs 17 
#define TX_BET_ESPs 16
...
void loop() 
{
  ...
  if (serial_received_data.isEmpty()==false)
  {
    ...
    Serial.print(("Enviado ao ESP1: " + serial_received_data + String(end_of_line)));
  ...
  if (serial_received_data.isEmpty()==false)
  {
    ...
    Serial.print(("Recebido do ESP1: " + serial_received_data + String(end_of_line)));
  }
